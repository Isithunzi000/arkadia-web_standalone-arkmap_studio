...
- [Mega-test silników map — 2026-08-27](https://isithunzi000.github.io/arkadia-web_standalone-arkmap_studio/docs/megatest_raport_2026-08-27.html) — jedna drabinka (27k–432k pokoi) na 3 silnikach: ArkMap (Node), czytnik mudlet-web i Mudlet desktop; wczytanie + pathfinding + przeszukanie + iteracja + pamięć na każdym silniku; deterministyczne 100 par pokoi i 3 frazy (seed), 5 przebiegów, jedna maszyna i jedna sesja ([`tests/megatest/`](tests/megatest/))
