// Harness Tier 3 (v1.45.3) — sumy v4 XXH3-64 (W3, implementacja Arc 19, migracja Arc 20),
...
// usuniete w v1.45.3 — kalka na XXH3-64)
...
console.log('── T2 (W3): addChecksums/verifyChecksums — v4, badAreas, missingRooms, algMismatch ──');
{
  ...
  // Arc 20 (v1.45.3): kazdy alg != v4 to GLOSNY algMismatch (present:true, ok:false) —
...
console.log('── T7: strazniki strukturalne Tier 3 + piny wersji ──');
{
  ...
  ok((deltaSrc.match(/v1\.45\.3/g) || []).length === 10, 'pin: delta.js 10x v1.45.3 (4 linie x includes+label + 2 komentarze Arc 20)');
