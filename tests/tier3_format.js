...
console.log('── T7: strazniki strukturalne Tier 3 + piny wersji ──');
{
  ...
  ok((deltaSrc.match(/v1\.50\.1/g) || []).length === 9, 'pin: delta.js 9x v1.50.1 (4 linie x includes+label + 1 adnotacja; fala 3: adnotacja integracji przeszla na P3b bez numeru wersji)');
