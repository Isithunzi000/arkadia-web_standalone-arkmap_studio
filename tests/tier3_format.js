// Harness Tier 3 (v1.48.3) — sumy v4 XXH3-64 (W3, implementacja Arc 19, migracja Arc 20),
...
// usuniete w v1.48.3 — kalka na XXH3-64)
...
{
  ok(NEW.includes("const APP_VERSION = 'v1.50.0';"), 'pin: APP_VERSION v1.50.0');
  const deltaSrc = fs.readFileSync(path.join(ROOT, 'tests', 'delta.js'), 'utf8');
  ok((deltaSrc.match(/v1\.50\.0/g) || []).length === 9, 'pin: delta.js 9x v1.50.0 (4 linie x includes+label + 1 adnotacja; fala 3: adnotacja integracji przeszla na P3b bez numeru wersji)');
