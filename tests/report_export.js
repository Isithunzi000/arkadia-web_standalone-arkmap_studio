...
console.log('── T2: buildDiagnosticsReport (funkcjonalnie) ──');
{
  ...
  const api = new Function('APP_VERSION', code)('v1.45.3');
  ...
  ok(r1.includes('- Wersja aplikacji: v1.45.3'), 'naglowek: wersja aplikacji');
...
console.log('── T4: _deltaReviewReportText (funkcjonalnie) ──');
{
  ...
  const api = new Function('APP_VERSION', 'state', code)('v1.45.3', state);
