...
console.log('— T2: buildDelta — determinizm i kształt pliku —');
{
  ...
  ok(d.meta.format === 'arkdelta' && d.meta.format_version === 2, 'meta: format + format_version 2 (v1.49.7)');
...
ok(HTML.includes("const APP_VERSION = 'v1.49.7';"), 'wersja: v1.49.7');
...
}
{
  ...
  ok(HTML.includes("const APP_VERSION = 'v1.49.7';"), 'wersja v1.49.7 w HTML');
}
{
