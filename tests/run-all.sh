...
cd "$(dirname "$0")/.."
FAILED=0
for t in tests/a12a14_undo_core.js tests/a13_delete_area.js tests/a7_readbuffer.js tests/a9_pixmap.js tests/dir_filter.js tests/pathfinding_cache.js tests/transport.js tests/share_link.js tests/planner_ui.js tests/sync_map.js tests/dir_validation.js tests/transports_sync.js tests/converters_crc.js tests/delta.js tests/checksum_defer.js tests/checkpoint_stash.js tests/cost_gate.js tests/search_index.js tests/ui_strings.js tests/ci_workflow.js tests/tier2_state.js tests/tier3_format.js tests/tier4_hardening.js tests/tier5_audit.js tests/tier6_ux.js tests/diff_kalka.js tests/pwa.js tests/xss_sinks.js tests/malformed_dat.js tests/validate_full.js tests/universal_colors.js tests/checksums_v4.js tests/report_export.js tests/checksums/xxh3_golden.js tests/checksums/xxh3_fuzz_equiv.js tests/save_dialogs.js tests/fix_batch_v1445.js tests/suppressors_load.js tests/changelog_tags.js tests/perf_counters.js tests/raf_shim.js tests/empirical_runner.js tests/arc41_regress.js tests/audit_ext.js tests/preserve_unknown.js tests/delta_compact.js tests/identity_wordlist.js tests/identity_dialog.js tests/delta_sig.js tests/arkmap_sig.js tests/registry_client.js tests/trust_store.js tests/g6_crosscheck.js; do
  echo "═══ $t ═══"
  node "$t" || FAILED=1
  echo
done
...
if [ -n "${CHROMIUM_BIN:-}" ] || command -v chromium >/dev/null 2>&1; then
  ...
  CAMP_GROUPS="SMOKE E0 E1 E2 E3 E4 E5 E6 E7 E8 E9 E10 E11 E12 E13 E14 E16 E17 E18 E19 E20 E21 E22 E23 E24 E25 E26 E27 E28"
